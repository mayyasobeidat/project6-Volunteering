...
namespace project_6
{
    public partial class WebForm4 : System.Web.UI.Page
    {
        ...
        protected void btn_vol_Click(object sender, EventArgs e)
        {
            ...
            {
                // Creating Connection  
                con21 = new SqlConnection("data source=  DESKTOP-SAVUMCP\\SQLEXPRESS; database=Project-6; integrated security=SSPI");
                // writing sql query  
            ...
            SqlConnection conn = new SqlConnection("data source=DESKTOP-SAVUMCP\\SQLEXPRESS; database=Project-6; integrated security=SSPI");
            SqlCommand command = new SqlCommand($"insert into Volunteer (Full_name_Vol,Phone_Vol,City,Details, Id) values('{txtName.Text}','{txtPhone.Text}', '{DropDownList1.SelectedValue}','{txtDetalis.Text}', '{idTest}')", conn);
            conn.Open();
