<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="User-Profile.aspx.cs" Inherits="project_6.WebForm7" %>
    ...
    <div class="main-body">
     ...
     <div class="row gutters-sm">
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    ...
                    <img src="ref.png" alt="Admin" class="rounded-circle" width="150">
                      <br />
                      <br />
                      <asp:FileUpload runat="server" ID="Upload" />          
                      <asp:Button ID="btnimg" runat="server" Text="Save" OnClick="btnimg_Click" />
         ...
         <%--      <%
                ...
                SqlConnection con = new SqlConnection("data source=DESKTOP-SAVUMCP\\SQLEXPRESS ; database=MobileZone ; integrated security = SSPI");
                con.Open();
  ...
  <tr>
    <td align="center">
      <h1 class="crt_title">Certificate Of Completion</h1>
        ...
        <h1 class="colorGreen crt_user">Haitham Alhazaymeh</h1>
