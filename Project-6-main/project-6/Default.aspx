...
*/
    ...
    @media only screen and (min-device-width: 481px) and (max-device-width:768px) {
        ...
        .small_img {width: 100%;float: right;}
        
        .col-md-2 {width:20%;}

        .secf h3 {font-size: 28px;}

        .features_2 {padding: 0 6%;}
      ...
      .flip-box {width: 220px;height: 120px;}
...
*/
    @media only screen and (min-device-width: 0px) and (max-device-width:480px) {
        ...
        .disc_pc {font-size: 15px !important;padding: 15px 0;}
        ...
        .thumbnail_1s{margin-right: 40px;}
   ...
   <section  class="features features_2">
    ...
    <div class="cards">
      <div>
        <div>
         <p><b>Hope Organization is a team of charitable youth to make the oppressed and needy happy, driven by love and faith.
      ...
      <h2>How we work ?</h2>
            ...
            <div class="workBox">
                <p><b>1. Ask for service</b>
                    <br>Submit a donation request through the website or application</p>
                <div class="col-md-2"><img src="images/queries.png"  class="small_img" /></div>
            </div>

                <div class="workBox">
                <p><b>2. Confirmation</b>
                    <br>We will contact you to confirm the date and address of receipt</p>
                ...
                <p><b>3. Receipt of donations</b>
                    <br>Receive your donations from your home for free within 24 hours</p>
                <div class="col-md-2"><img src="images/bill.png"  class="small_img" /></div>
            </div>

                <div class="workBox">
                <p><b>4. Recycling</b>
                    <br>Sorting and recycling donations by our specialized team</p>
                <div class="col-md-2"><img src="images/recycle.png"  class="small_img" /></div>
            </div>

                <div class="workBox">
                <p><b>5. Distribution</b>
                    <br>Distributing donations to the needy through the <b>Hope</b> volunteer team <br />and under the supervision of approved charities</p>
